...
<div class="container">
	<div class="col-md-12">
		<h1 class="text-center">Deals Home Sheet</h1>
	</div>
  <div class="row">
  	<div class="col-md-12">
	    <?php
        ...
        <input type="hidden" name="id" id="id" value="<?php echo $row[0]->id ?>">
		 <input type="hidden" name="edit_type" id="edit_type" value="deals_edit" />
		  			...
		  			<table class="table-responsive table-condensed">
		  				...
		  				<tbody>
		  					<tr>
		  						...
		  						<td>
		  							<input type="text" maxlength="4" id="cvc" name="cvc" class="form-control" placeholder="" value="<?php echo $row[0]->cvc1; ?>">
		  						</td>
		  						<td>
								...
								<div class="input-box">
		  						...
		  						<td>
									...
									<div class="input-box">
									  <input type="text" id="int_rate" style="" readonly name="int_rate" class="form-control" placeholder="" value="<?php echo $row[0]->int_rate; ?>">
									  <span class="unit">$</span>
									</div>
		  						</td>
		  						<td>
			...
			<div class="panel-heading">
		  	...
		  	<div id="notes" class="panel-body">
		    	...
		    	<div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-9">
				      <select name="send_status" id="send_status" placeholder="Send Status"  class="form-control state" >
			  ...
			  <div class="form-group">
			    ...
			    <!--	<a href="#" id="save" class="btn btn-primary">Save</a>
			    	<a href="#" id="submit" class="btn btn-primary">Updated</a>-->
					...
					<!--
					    	<button type="submit" href="#" name="Updated" id="submit" class="btn btn-primary">Updated</button>-->
