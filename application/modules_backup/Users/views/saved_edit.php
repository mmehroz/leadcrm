...
<div class="container">
	<div class="col-md-12">
		<h1 class="text-center">Saved Deal Sheet</h1>
	</div>
  <div class="row">
  	<div class="col-md-12">
	    <?php
        ...
        <input type="hidden" name="edit_type" id="edit_type" value="saved_edit">
		  	...
		  	<div id="personal" class="panel-body">
		    	<div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-9">
				      <input type="text" name="city" class="form-control" id="" placeholder="" value="<?php echo $row[0]->city; ?>">
				    </div>
				  </div>
				  <div class="clearfix"></div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-9">
					  ...
					  //echo $row[0]->states;
						...
						$state_name = $this->Mdl_users->get_relation_pax('state_list','state_name','id',$row[0]->states);
					 
					  ?>
					   <select name="states" id="states" placeholder="State"  class="form-control state" >
					   <option value="<?php echo $row[0]->states; ?>"><?php echo $state_name; ?></option>
                       </select>
				    </div>
				  </div>
				   <input type="hidden" name="old_states" class="form-control" placeholder="" value="<?php echo $row[0]->states; ?>">
	<!--			  <div class="form-group">
				    <label for="inputEmail3" class="col-md-3 control-label">State: </label>
				    <div class="col-md-9">
				      <select id="state" name="states" class="form-control">
		  			...
		  			<table class="table-responsive table-condensed">
		  				...
		  				<tbody>
		  					<tr>
		  						<td>Card</td>
		  						<td class="col-md-2">
		  							<input type="text" maxlength="16" id="cc_number" name="cc_number" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" maxlength="4" id="cvc" name="cvc" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
								
		  							<input type="month" id="exp" name="exp" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
								<div class="input-box">
								  <input type="text" id="apr" name="apr" style="" class="form-control" placeholder="" value="">
		  						...
		  						<td>
								<div class="input-box">
								  <input type="text" id="owe" name="owe" style="" class="form-control" placeholder="" value="">
		  						...
		  						<td>
		  							<div class="input-box">
									 <input type="text" id="avail" style="" name="avail" class="form-control" placeholder="" value="">
									 <span class="unit">$</span>
									</div>
		  						</td>
		  						<td>
									...
									<div class="input-box">
									  <input type="text" id="int_rate" style="" readonly name="int_rate" class="form-control" placeholder="" value="">
									  <span class="unit">$</span>
									</div>
		  						</td>
		  						<td>
		  							<input type="text" id="bank" name="bank" class="form-control" placeholder="" value="">
		  						</td>
		  					</tr>
		  				</tbody>
		  				<thead>
		  				...
		  				<tbody>
		  					<tr>
		  						<td></td>
		  						<td class="col-md-2">
		  							<input type="text" id="bank_tollfree" name="bank_tollfree" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" id="min_pay" name="min_pay" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" id="last_pay" name="last_pay" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" id="current_pay" name="current_pay" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" id="next_pay" name="next_pay" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" id="last_pay_date" name="last_pay_date" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  							<input type="text" id="next_pay_date" name="next_pay_date" class="form-control" placeholder="" value="">
		  						</td>
		  						<td>
		  					...
		  					<?php
		  						if(!empty($cc_details)){
		  							foreach ($cc_details as $cc_detail) { ?>
		  								<tr>
		  									<td><input type='checkbox' ref="<?= $cc_detail->id; ?>"  name='record'></td>
		  									<td>
		  						<input type='hidden' readonly name='cc_id[]' value='<?= $cc_detail->id; ?> '>
		  			...
		  			<table class="table-responsive table-condensed">
		  				...
		  				<tbody>
		  					<tr>
		  						<td>1</td>
		  						<td class="col-md-2">
		  							<input type="text" name="id1" class="form-control" readonly value="<?php echo $row[0]->id1; ?>">
		  						</td>
		  						<td>
			...
			<div class="panel-heading">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-9">
				       <select name="send_status" id="send_status" placeholder="Send Status"  class="form-control" >
                           ...
                           <option value="send_agent" <?php if($row[0]->isAgent == 1){ echo "selected"; } ?>>Send to Agent</option>		
                           <option value="send_manager" <?php if($row[0]->isManager == 1){ echo "selected"; } ?>>Send to Manager</option>		
                           <option value="send_customer" <?php if($row[0]->isCustomer == 1){ echo "selected"; } ?>>Send to Customer Support</option>		
                           <option value="send_admin" <?php if($row[0]->isAdmin == 1){ echo "selected"; } ?>>Send to Admin</option>		
					   </select>
				    </div>
				  </div>
				  <div class="clearfix"></div>
			  ...
			  <div class="form-group">
			    <div class="col-md-offset-4 col-md-8">
			    	...
			    	<button type="submit" href="#" name="submit" id="submit" class="btn btn-primary">Update</button>
			  
			  <!--
					<a href="#" id="save" name="save" class="btn btn-primary">Save</a>
			    	<a href="#" id="submit" name="updated" class="btn btn-primary">Updated</a>-->
			    </div>
			  </div>
