                            ...
                            <tbody>
                                <?php foreach($result_set as $key => $row) { ?>
                                    ...
                                    <tr>
										...
										if($row->modify_date != "")
										{
										//$user_name1 = $this->Mdl_users->get_relation_pax('login','username','id',$row->modify_by);
										//$account_name1 = $this->Mdl_users->get_relation_pax('login','account_title','id',$row->modify_by);
