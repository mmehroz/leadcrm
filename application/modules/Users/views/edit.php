		  						...
		  						if(!empty($cc_details)){
		  							foreach ($cc_details as $cc_detail) { ?>
		  								<tr>
		  									...
		  									<td>
		  										<input type='hidden'  name='bank_tollfree[]' value='<?= $cc_detail->bank_tollfree ?> '>
		  										<input type='hidden'  name='min_pay[]' value='<?= $cc_detail->min_pay ?> '>
		  										<input type='hidden'  name='last_pay[]' value='<?= $cc_detail->last_pay ?> '>
		  										<input type='hidden'  name='current_pay[]' value='<?= $cc_detail->current_pay ?> '>
		  										<input type='hidden'  name='next_pay[]' value='<?= $cc_detail->next_pay ?> '>
		  										<input type='hidden'  name='last_pay_date[]' value='<?= $cc_detail->last_pay_date ?> '>
		  										<input type='hidden'  name='next_pay_date[]' value='<?= $cc_detail->next_pay_date ?> '>
		  									</td>
		  								</tr>
		  					<?php	}
		  						}
