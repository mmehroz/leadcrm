...
<div class="page-content">
    <div class="page-header">
        <h1>
			...
			<?php
			if($this->uri->segment(3) != "logo_list")
			{
				?>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            ?>
    <?php if($this->uri->segment(3) == "adds_list")
            { 
                if($this->uri->segment(4))
                {
                    ?>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <?php
                            $brand_image_update = $this->Mdl_hierarchy->get_relation_pax('adds_list','adds_image','id', $this->uri->segment(4));
                            ?>
                            <input type="hidden" name="old_image" id="old_image" value="<?php echo $brand_image_update;?>">
                            <?php
                            ...
                            if($brand_image_update != "")
                            {
                                ?>     
                                <div class="" id="result_pic"> 
                                    <img id="myImg" src="<?php echo base_url().'public_html/frontend/image/adds/'.$brand_image_update; ?>" style="width: 180px; height: 150px;" alt="your image"  />
                                </div>
                                <div id="upload_img" class="">
                                    <button class="btn" type="button" tabindex="23"  onClick="cancel_preview_image()">
                                        <i class="icon-undo bigger-110"></i>Cancel
			 ...
			 <?php if($this->uri->segment(3) == "logo_list")
            {
                ...
                if($this->uri->segment(4))
                {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <?php
                            $brand_image_update2 = $this->Mdl_hierarchy->get_relation_pax('logo_list','logo_image','id', $this->uri->segment(4));
							
							//print_r($brand_image_update);
                            ?>
                            <input type="hidden" name="old_image" id="old_image" value="<?php echo $brand_image_update2;?>">
                            <?php


                            if($brand_image_update2 != "")
                            {
                                ?>

                                <div class="" id="result_pic">
                                    <img id="myImg" src="<?php echo base_url().'public_html/frontend/image/logo/'.$brand_image_update2; ?>" style="width: 180px; height: 150px;" alt="your image"  />
                                </div>
                                <div id="upload_img" class="">
                                    <button class="btn" type="button" tabindex="23"  onClick="cancel_preview_image()">
                                        <i class="icon-undo bigger-110"></i>Cancel
