                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
							...
							if($table != "logo_list" && $table != "delivery_charges_list" && $table != "request_call")
							{
				  ?>
                                    ...
                                    <?php foreach($result_set as $key => $row) { ?>
                                        ...
                                        <tr>
                                            ...
                                            foreach($column as $col => $val){ 
                                               ...
                                               }else  if($val == "Adds Image")
                                               {

                                                   if($row->$col != "")
                                                   {
                                                       ?>
                                                       <td><img src="<?php echo base_url().'public_html/frontend/image/adds/'.$row->$col; ?>" style="height:100px;width:100px;" /></td>
                                                   <?php
                                                   }
                                                   else
                                                   {
                                            ...
                                            ?> 
												...
												else if($table == "delivery_charges_list" || $table == "request_call" )
                                                {
                                                   /*  ?>
                                                    <label class=" inline">
                                                        <input  ref="<?php echo $row->id; ?>" table="<?php echo $table; ?>"  <?php if($row->is_enable == 0){ echo 'value="0" ';}else{echo 'value="1" checked="checked"';}  ?>    type="checkbox" class="ace ace-switch ace-switch-5 status_month" />
