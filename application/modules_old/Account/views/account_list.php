                            ...
                            <tbody>
                                ...
                                { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class=" inline">
                                                <input  ref="<?php echo $row->id; ?>"  <?php if($row->is_enable == 0){ echo 'value="0" ';}else{echo 'value="1" checked="checked"';}  ?>    type="checkbox" class="ace ace-switch ace-switch-5 <?php if($this->session->userdata('user_type') != 'seller'){ echo "status_user"; }?>" />
                                                <span class="lbl"></span>
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="<?php echo base_url('Account/account_list/'.$row->id.''); ?>"
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a class="green" href="<?php echo base_url('Account/action/'.$row->id.''); ?>" >
